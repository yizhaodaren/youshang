...
@interface MOLQuicklyLoginView ()<UITextFieldDelegate, YYTextKeyboardObserver>
...
@implementation MOLQuicklyLoginView
...
- (void)calculatorQuicklyLoginViewFrame
{
    ...
    self.codeBoardView.x = self.boardView.x;
    self.codeBoardView.y = self.boardView.bottom + 5;
...
- (void)layoutSubviews
{
    ...
    [self calculatorQuicklyLoginViewFrame];
}
