...
@interface MOLUserAgreeCell ()
@property (nonatomic, weak) UIImageView *iconImageView;
@property (nonatomic, weak) UILabel *nameLabel;
@property (nonatomic, weak) UILabel *subNameLabel; // 赞了你的作品
@property (nonatomic, weak) UILabel *introduceLabel;  // 时间
@property (nonatomic, weak) UIImageView *productionImageView;
@property (nonatomic, weak) UIView *lineView;
@end

@implementation MOLUserAgreeCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
        [self setupUserAgreeCellUI];
...
- (void)setAgreeModel:(MOLMsgAgreeModel *)agreeModel
{
    _agreeModel = agreeModel;
    
    [self.iconImageView sd_setImageWithURL:[NSURL URLWithString:agreeModel.baseUserVO.avatar]];
    self.nameLabel.text = agreeModel.baseUserVO.userName;
    self.subNameLabel.text = agreeModel.content;
    self.introduceLabel.text = [NSString getCommentMessageTimeWithTimestamp:agreeModel.createTime];
    
    [self.productionImageView sd_setImageWithURL:[NSURL URLWithString:agreeModel.avatar]];
}
...
- (void)clickIconImageView
{
    ...
    if ([self.agreeModel.baseUserVO.userId isEqualToString:user.userId]) {
        ...
        vc.userId = self.agreeModel.baseUserVO.userId;
        [[[MOLGlobalManager shareGlobalManager] global_currentNavigationViewControl] pushViewController:vc animated:YES];
    }
}

#pragma mark - UI
- (void)setupUserAgreeCellUI
{
...
- (void)calculatorUserAgreeCellFrame
{
...
- (void)layoutSubviews
{
    ...
    [self calculatorUserAgreeCellFrame];
}
