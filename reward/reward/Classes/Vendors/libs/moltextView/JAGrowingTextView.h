...
@class JAGrowingTextView;

@protocol JAGrowingTextViewDelegate <NSObject>
@optional
...
- (BOOL)textViewShouldEndEditing:(JAGrowingTextView *)growingTextView;
...
@interface JAGrowingTextView : UIScrollView

@property (nonatomic,strong) JAGrowingInternalTextView *textView;

@property (nonatomic,weak) id<JAGrowingTextViewDelegate> textViewDelegate;
...
@interface JAGrowingTextView(TextView)
