...
@interface JAGrowingTextView()<UITextViewDelegate>

//@property (nonatomic,strong) JAGrowingInternalTextView *textView;
...
@implementation JAGrowingTextView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        JAGrowingInternalTextView *textView = [[JAGrowingInternalTextView alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        JAGrowingInternalTextView *textView = [[JAGrowingInternalTextView alloc] initWithFrame:CGRectZero];
        self.textView = textView;
...
{
    if ([self.textViewDelegate respondsToSelector:@selector(growingTextView:shouldChangeTextInRange:replacementText:)]) {
        return [self.textViewDelegate growingTextView:self shouldChangeTextInRange:range replacementText:text];//[self.textViewDelegate shouldChangeTextInRange:range replacementText:text];
    }
    return YES;
}
...
@implementation JAGrowingTextView(TextView)
...
{
    self.textView.enablesReturnKeyAutomatically = !enablesReturnKey;
}
