//
//  NSDictionary+MOLDictionaryExtention.m
//  aletter
//
...
#import "NSDictionary+MOLDictionaryExtention.h"

@implementation NSDictionary (MOLDictionaryExtention)
...
{
    NSArray *array = [self mol_jsonArray:key];
    BOOL invalid = NO;
